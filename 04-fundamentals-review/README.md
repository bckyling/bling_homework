...
| --- | --- | --- |
| Unit Activity |  Describes summative activity required for this unit | [Here](https://git.generalassemb.ly/course-materials/tree/master/unit-1) |
| Final Project  | Lists deliverables and requirements for our course final project | [Here](https://git.generalassemb.ly/course-materials/tree/master/unit-4) |
...
**Unit Activity Workshop** (1.5-2 hours)
 - [Assign students to work on the unit project activity in-class](https://git.generalassemb.ly/course-materials/tree/master/unit-1)
